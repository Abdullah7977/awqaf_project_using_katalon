...
WebUI.setText(findTestObject('Object Repository/Page_Home Page -/input__Password'), password)

WebUI.click(findTestObject('Object Repository/Page_Home Page -/input__button button-block_1'))

WebUI.click(findTestObject('Object Repository/Page_Home Page -/span_abdallah'))
